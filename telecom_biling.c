...
void addrecords()
{
    FILE *f;
    char test;
    f = fopen("d:/file.ojs", "ab+");  // Updated file path
    if(f == NULL)
    {   
        f = fopen("d:/file.ojs", "wb+");  // Updated file path
        system("cls");
...
void listrecords()
{
    FILE *f;
    int i;
    if((f = fopen("d:/file.ojs", "rb")) == NULL)  // Updated file path
        exit(0);
    system("cls");
...
void deleterecords()
{
    ...
    int i = 1;
    char phonenumber[20];
    if((t = fopen("d:/temp.ojs", "w+")) == NULL)  // Updated file path
        exit(0);
    if((f = fopen("d:/file.ojs", "rb")) == NULL)  // Updated file path
        exit(0);
    system("cls");
    ...
    {   
        ...
        remove("d:/file.ojs");  // Updated file path
        rename("d:/temp.ojs", "d:/file.ojs");  // Updated file path
        getch();
        fclose(f);
        fclose(t);
        main();
...
void searchrecords()
{
    ...
    char phonenumber[20];
    int flag = 1;
    f = fopen("d:/file.ojs", "rb+");  // Updated file path
    if(f == NULL)
        exit(0);
    fflush(stdin);
    system("cls");
